...
#include <memory>
#include "../../../../../Documents/GitHub/Pong_Cpp_Qt/PONG_Cpp/score.h"
...
QT_MOC_LITERAL(6, 15), // "playerWinSignal"
QT_MOC_LITERAL(22, 0), // ""
QT_MOC_LITERAL(23, 12) // "cpuWinSignal"

    },
    "Score\0playerWinSignal\0\0cpuWinSignal"
};
...
void Score::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->playerWinSignal(); break;
        case 1: _t->cpuWinSignal(); break;
        default: ;
        }
        ...
        {
            using _t = void (Score::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Score::playerWinSignal)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Score::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Score::cpuWinSignal)) {
                *result = 1;
                return;
            }
        }
...
, QtPrivate::TypeAndForceComplete<Score, std::true_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>, QtPrivate::TypeAndForceComplete<void, std::false_type>
...
// SIGNAL 0
void Score::playerWinSignal()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void Score::cpuWinSignal()
{
